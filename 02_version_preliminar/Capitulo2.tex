...
\paragraph{Sintiendo el medio ambiente}
...
\subsection{Plataformas de Control Robòtico}

Una plataforma de control robòtico es aquella que contiene instrucciones en còdigo para decirle a un sistema electrónico y mecánico, conocido de otra forma como robot, qué tareas realizar. Este software tiene como objetivo ofrecer funcionalidades definidas, abstrayendo los componentes de hardware y proveyendo funciones para el control de los mismos, facilitando el uso de estos y la incorporación de distintos componentes segùn sea necesario.
